...
//	public static final String LAST_MODIFIED = "LastModified"; // timestamp
	...
	public static final String DATE          = "Date"; // TODO: this should be timestamp converted to lucene format (thus we could use querying instead of filtering)
	public static final String TYPE          = "Type";        // DIR or FILE

	public static final String INDEXED       = "Indexed"; // timestamp converted to lucene format (for sorting/querying)
